...
const PostViewText = (likable, toggleLike, commentID, commentObj, commentIdx, replyID=null) => {
    return (
        <div className="PostViewTextOuterContainer" key={commentIdx}>
            <div className='.PostViewTextContainer'>
                <div className='PostViewTextContainerInline'>
            ...
            {commentObj.liked ?
                    <svg className="CommentLikeButtonImage Button" 
                        viewBox="0 0 48 48" 
                        onClick={() => {toggleLike("testUserID", commentID, replyID)}}
                        fill="#ed4956">
